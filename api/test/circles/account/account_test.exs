defmodule Circles.AccountTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{avatar: "some avatar", background: "some background", handle: "some handle"}
    ...
    test "create_user/1 with valid data creates a user" do
      ...
      assert user.background == "some background"
    ...
    test "update_user/2 with valid data updates the user" do
      ...
      assert user.background == "some updated background"
